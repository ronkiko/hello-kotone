...
func _process(delta: float) -> void:
	...
	set_bone("Hip/ArmFarUpper", deg_to_rad(-stride * 12.0))
	set_bone("Hip/ArmFarUpper/ArmFarLower", deg_to_rad(6.0 + maxf(0.0, stride) * 8.0))
	set_bone("Hip/ArmFarUpper/ArmFarLower/ArmFarHand", deg_to_rad(-3.0))
	set_bone("Hip/ArmNearUpper", deg_to_rad(stride * 12.0))
	set_bone("Hip/ArmNearUpper/ArmNearLower", deg_to_rad(6.0 + maxf(0.0, -stride) * 8.0))
	set_bone("Hip/ArmNearUpper/ArmNearLower/ArmNearHand", deg_to_rad(-3.0))

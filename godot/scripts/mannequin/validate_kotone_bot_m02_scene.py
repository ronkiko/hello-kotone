...
def main() -> None:
    ...
    require(m03["status"] == "six_part_assets_approved_ready_for_skeleton", "M03 asset gate status changed")
    require(len(m03["assets"]) == 6 and m03["runtime_scene"] is None, "M03 asset-only gate changed")

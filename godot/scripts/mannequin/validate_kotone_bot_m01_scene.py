...
def main() -> None:
    ...
    require('scale = Vector2(0.04, 0.04)' in scene, "world-relative model scale changed")
    require('size = Vector2(22, 44)' in scene, "collision dimensions changed")
    require('position = Vector2(0, -22)' in scene, "collision floor registration changed")
    require('zoom = Vector2(6, 6)' in scene, "enlarged world camera zoom missing")

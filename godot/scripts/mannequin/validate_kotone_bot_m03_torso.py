...
def main() -> None:
    ...
    require('bones = ["Torso", PackedFloat32Array(1, 1, 1, 1)]' in rig, "torso polygon must be fully weighted to Torso")
    require('bones = ["Torso/Head", PackedFloat32Array(1, 1, 1, 1)]' in rig, "head polygon must be fully weighted to Head")

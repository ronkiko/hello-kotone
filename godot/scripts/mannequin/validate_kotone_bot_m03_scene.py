...
def main() -> None:
    ...
    require(len(re.findall(r'type="Bone2D"', rig)) == 9, "expected nine M03 bones")
    require(len(re.findall(r'name="Art_[^"]+" type="Sprite2D"', rig)) == 9, "expected nine M03 art nodes")
    require('name="Art_far_arm"' in rig and 'name="Art_arm_near"' in rig, "two complete side arms missing")
    ...
    require('set_bone("Hip/ArmFar"' in preview_script, "far arm gait phase missing")
